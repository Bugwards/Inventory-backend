        ...
        if(groupName.equals("All")) {
            ...
            for (Item item : itemList) {
                ...
                List<Stock> stockList = stockRepository
                        .findByItemIdAndLocation(item.getId(), locationName);
            ...
            List<ItemGroup> itemGroupList = itemGroupRepository.findByName(groupName);
            List<Item> itemList = new ArrayList<>();
    ...
    public List<ReOrderResponse> reorderBalanceReport(Location locationName, String groupName) {
        ...
        if (groupName.equals("All")) {
            ...
            for (Item item : itemList) {
                ...
                for (Stock stock : stockList) {
                    totaleCurrentBalance += stock.getCurrentQty();
                    totaleActualBalance += stock.getActualQty();
                }
    ...
    public List<GrnWiseReportResponse> grnBalanceReport(Location locationName, String groupName){
        ...
        if(groupName.equals("All")) {
            ...
            for (Item item : itemList) {
                ...
                GrnWiseReportResponse response = new GrnWiseReportResponse();
...
//--for front end's ITEM GROUP's dropdown menu--------------------------------------------------------------------//

    public List<String> itemGroupNamesGetting( ) {
        System.out.println("mn awaaaaa");
        List<ItemGroup> itemGroupList = itemGroupRepository.findAll();
        System.out.println(itemGroupList.size());
        ...
        System.out.println("Listtttttttt"+itemNameList);
        return itemNameList;
    }
    }